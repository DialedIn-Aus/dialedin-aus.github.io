...
Atlernatively instead of `esptool`, you can use [ESPHome Web][3] to flash the firmware from any Chrome based web browser. For convenience you can find a pre-built firmware [wt32-eth01-bt-proxy.bin][4] on our github site.
...
[4]: https://github.com/DialedIn-Aus/esphome-configs/raw/main/bt-proxy/wt32-eth01-bt-proxy.bin